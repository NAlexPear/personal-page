...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite_js__);
...
function Move() {
    ...
    this.menu = {
        close(menu, icon) {
            __WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite_js___default.a.to(menu, 0.2, { "left": "-400px" });
            menu.className = menu.className.replace(" expanded", "");
            icon.className = icon.className.replace("ti-close", "ti-menu");
        },
        open(menu, icon) {
            __WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite_js___default.a.to(menu, 0.2, { "left": "0px" });
        ...
        ul.addEventListener("click", e => {
            ...
            if (li && li.nodeName === "LI") {
                ...
                if (blurb.className.match(/expanded/)) {
                    removeClasses();
                    __WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite_js___default.a.to(blurb, 0.2, { "height": "0" });
                } else {
                    addClasses();

                    __WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite_js___default.a.to(blurb, 0.2, { "height": "7em" });
                    ...
                    for (let i = 0; i < otherLi.length; i++) {
                        if (otherLi[i].className) {
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_gsap_TweenLite_js___default.a.to(otherBlurb, 0.2, { "height": "0" });
                        }
                    }
                }
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mobile__ = __webpack_require__(1);



var move = new __WEBPACK_IMPORTED_MODULE_0__animations__["a" /* default */]();
var mobile = new __WEBPACK_IMPORTED_MODULE_1__mobile__["a" /* default */]();
